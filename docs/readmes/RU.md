...
<p align="center">
  <a href="https://github.com/md2it/ai-limits/releases/download/v0.5.0/AI-Limits-v0.5.0-macos-arm64.dmg"><img src="https://shieldcn.dev/badge/macOS-v0.5.0-grey.svg?logo=apple" alt="Скачать для macOS"></a>
  <a href="https://github.com/md2it/ai-limits/releases/download/v0.5.0/AI-Limits-v0.5.0-windows-setup.exe"><img src="https://shieldcn.dev/badge/Windows-v0.5.0-blue.svg?logo=ri:FaWindows" alt="Скачать для Windows"></a>
  <a href="https://github.com/md2it/ai-limits/releases/download/v0.5.0/AI-Limits-v0.5.0-linux.AppImage"><img src="https://shieldcn.dev/badge/Linux-v0.5.0-yellow.svg?logo=linux" alt="Скачать для Linux"></a>
</p>

<p align="center"><a href="https://github.com/md2it/ai-limits/releases/tag/v0.5.0">Все сборки</a></p>
