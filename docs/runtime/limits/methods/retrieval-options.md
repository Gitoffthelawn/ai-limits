...
| Cursor | `api2.cursor.sh` `GetCurrentPeriodUsage` via Cursor Agent token (`cursor_api2`) | Only implemented source. Provides numeric usage/limits through an unofficial backend contract; there is no CLI-based fallback source in code. | [../providers/cursor.md](../providers/cursor.md), [../../../product/analogs/cursor-api2-cursor-sh.md](../../../product/analogs/cursor-api2-cursor-sh.md) |
