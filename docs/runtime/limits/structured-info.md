...
Structured time fields may keep source-specific formats or UTC timestamps. The default terminal presentation converts them to the user's local time in the format documented in [terminal/interface.md](../../terminal/interface.md).
